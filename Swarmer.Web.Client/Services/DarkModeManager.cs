...
public sealed class DarkModeManager
{
	...
	public DarkModeManager(IServiceScopeFactory scopeFactory) => _scopeFactory = scopeFactory;

	public async Task Init()
	{
		using IServiceScope scope = _scopeFactory.CreateScope();
		DarkMode = await scope.ServiceProvider.GetRequiredService<ILocalStorageService>()
